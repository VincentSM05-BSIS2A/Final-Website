...
function getIPAddress() {
    // Check for the most common proxy headers
    ...
    return $_SERVER['REMOTE_ADDR'];  // Return the direct IP address
}
...
function cart() {
    ...
    if (isset($_GET['add_to_cart'])) {
        ...
        $select_query = "SELECT * FROM cart WHERE item_id = $get_item_id AND ip_address = '$ip'";
        ...
        if ($num_rows > 0) {
            ...
            $insert_query = "INSERT INTO cart (item_id, ip_address) VALUES ($get_item_id, '$ip')";
